...
public struct RecentMatch: Equatable, Codable {
  ...
  public static func sortByKillsDesc(lhs: RecentMatch, rhs: RecentMatch) -> Bool {
...
extension RecentMatch {
  public static func fixture() -> RecentMatch {
    RecentMatch(
      matchID: 100,
      playerSlot: 90,
      radiantWin: true,
